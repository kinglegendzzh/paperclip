    ...
    <div className="space-y-6">
      ...
      <Tabs value={mainTab} onValueChange={(value) => setMainTab(value as typeof mainTab)}>
        ...
        <TabsContent value="overview" className="mt-4 space-y-4">
          {showCustomPrompt ? (
            <p className="text-sm text-muted-foreground">{t("costs.selectDatePrompt")}</p>
          ) : showOverviewLoading ? (
            ...
            <>
              ...
              <div className="grid gap-4 xl:grid-cols-[1.3fr,1fr]">
                <Card>
                  <CardHeader className="px-5 pt-5 pb-2">
                    <CardTitle className="text-base">{t("costs.inferenceSpend")}</CardTitle>
              ...
              <div className="grid gap-4 xl:grid-cols-[1.25fr,0.95fr]">
                <Card>
                  <CardHeader className="px-5 pt-5 pb-2">
                    <CardTitle className="text-base flex items-center justify-between">{t("costs.budget")}</CardTitle>
            ...
            <>
              ...
              {activeBudgetIncidents.length > 0 ? (
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{t("costs.resolveHardStops")}</p>
                  </div>
                  <div className="grid gap-4 xl:grid-cols-2">
              ...
              <div className="space-y-5">
                ...
                {budgetPolicies.length === 0 ? (
                  <Card>
                    <CardContent className="px-5 py-8 text-sm text-muted-foreground">{t("costs.noBudgetPolicies")}</CardContent>
                  </Card>
                ) : null}
              </div>
            </>
