...
export function CliAuthPage() {
      ...
      <div className="mx-auto max-w-xl py-10">
        <div className="rounded-lg border border-border bg-card p-6">
          ...
          <Button asChild className="mt-4">
            <Link to={`/auth?next=${encodeURIComponent(currentPath)}`}>{t("common.signInOrCreate")}</Link>
          </Button>
        </div>
      </div>
    );
  ...
  return (
    <div className="mx-auto max-w-xl py-10">
      <div className="rounded-lg border border-border bg-card p-6">
        <h1 className="text-xl font-semibold">{t("cliAuth.approveCli")}</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          {t("cliAuth.cliRequestingAccess")}
        </p>
        ...
        <div className="mt-5 flex gap-3">
          ...
          >
            {cancelMutation.isPending ? t("common.cancelling") : t("common.cancel")}
          </Button>
        </div>
      </div>
    </div>
